...
class gameScene extends Phaser.Scene {
  ...
  buildSprites() {
    ...
    this.addSegmentSprite(60, 'sirius', -1);
    this.addSegmentSprite(40, 'billboard', 1);
    this.addSegmentSprite(40, 'billboard', -1);
    this.addSegmentSprite(20, 'droid2', -1);
    this.addSegmentSprite(10, 'droid1', 1);
    this.addSegmentSprite(5, 'billboard', 1);
    this.addSegmentSprite(5, 'billboard', -1);
    this.addSegmentSprite(800, 'safeSign', 1);
    this.addSegmentSprite(900, 'safeSign', -1);
    this.addSegmentSprite(600, 'safeSign', 1);
    this.addSegmentSprite(180, 'safeSign', 1);
    this.addSegmentSprite(300, 'safeSign', 1);
  }
